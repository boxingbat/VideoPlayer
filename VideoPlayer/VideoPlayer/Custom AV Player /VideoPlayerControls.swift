...
class VideoPlayerControls: UIView {
    ...
    func createOverlayViewWith(configuration: Configuration, theme: MBTheme, header: UIView?) {
...
extension VideoPlayerControls: UICollectionViewDataSource {
...
extension VideoPlayerControls: UICollectionViewDelegate {
